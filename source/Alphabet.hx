...
class Alphabet extends FlxSpriteGroup // Loosley based on FlxTypeText lolol
{
	...
	public function new(x:Float, y:Float, text:String = "", ?bold:Bool = false, typed:Bool = false, ?typingSpeed:Float = 0.05, ?textSize:Float = 1):Void
	{
		super(x, y);
